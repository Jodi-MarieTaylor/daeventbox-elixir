defmodule DaeventboxWeb.MessageControllerTest do
  use DaeventboxWeb.ConnCase

  alias Daeventbox.Chat

  @create_attrs %{body: "some body", force: "some force", recipient_id: 42, room_id: 42, sender_id: 42}
